...
set CLASSPATH=%APP_HOME%\lib\GradleTest.jar;%APP_HOME%\lib\guava-20.0.jar

@rem Execute GradleTest
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GRADLE_TEST_OPTS%  -classpath "%CLASSPATH%" MainApp %CMD_LINE_ARGS%
